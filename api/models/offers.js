                                                    ...
                                                    .then(data => {
                                                        ...
                                                        docs.map(doc => {
                                                            ...
                                                            if (doc.is_primary_offer === true) {
                                                                ...
                                                                eligible_status_text = "You have " + no_contacts + " friends and " + followers + " followers. Need atleast 100 connections."
                                                                ...
                                                                // console.log("final discount" + final_disc)
                                            ...
                                            if (req.body.is_primary_offer === true) {
                                                primaryOffers.find({_id: req.body.offer_id})
                                                    ...
                                                    .then(docs => {
                                                        ...
                                                        if (no_contacts >= 0 || followers >= 0 || no_contacts + followers >= 0) {
                                                            eligible_status = true
                                                        } else {
                                                            eligible_status = false
                                                            progress = 0
                                    ...
                                    if (docs.length < 1) {
                                        ...
                                        if (test.length > 0) {
                                            test.sort(function (a, b) {
                                                var date1 = new Date(a.redeemed_on), date2 = new Date(b.redeemed_on);
                    ...
                    if (user.length < 1) {
                        ...
                        userDetails.find({
                            ...
                            .then(docs => {
                                ...
                                var service_tax = parseFloat(0).toFixed(2)// parseFloat(final_amount_paid/100*2).toFixed(2)
                                ...
                                final_amount_paise = (parseFloat(final_amount).toFixed(2))*100

                                amount_paid = (req.body.paid_amount)/100
                                ...
                                if(parseInt(final_amount_paise) === parseInt(req.body.paid_amount)){
                                    console.log("In amount ")
                                                                ...
                                                                .then(data => {
                                                                    ...
                                                                    bsOffers.findOneAndUpdate({_id: req.body.offer_id}, {$set: {no_of_items: String(stock)}})
                                                                        ...
                                                                        .then(dex => {
                                                                            ...
                                                                            userDetails.findOneAndUpdate({userid: ObjectId(req.body.userid)},
                                                                                {$push: {pending_rating: {offer: ObjectId(req.body.offer_id)}}})
                                                                                .exec()
                                                                                .then(datas => {
                                            ...
                                            var redeem_details = new offerRedeemModel({
                ...
                .then(user => {
                    if (user.length < 1) {
                        ...
                        userDetails.find({
                            ...
                            {'offer_details.$': 1, _id: 1, userid: 1})
                        ...
                        userDetails.find({userid: ObjectId(req.body.userid)})
                            ...
                            .then(data => {
                                if (data.length < 1) {
                                    ...
                                    primaryOffers.find({_id: {$nin: active_offers}})
                                        .skip(skip)
                                        .limit(limit)
            ...
            authModel.find({iv_token: req.body.iv_token})
                ...
                .then(user => {
                    if (user.length < 1) {
                        ...
                        bsOffers.find({_id: req.body.offer_id},
                            {rating: 1, offer_rating: 1, review_status: 1})
                            .exec()
                            .then(result => {
                                var is_rated = true;
    ...
    userDetails.find({})
        ...
        .then(data => {
            ...
            mobile_verified.map(doc => {
                contactsModel.distinct("existing_contacts.contact", {userid: ObjectId(doc.userid._id)})
                    .exec()
                    .then(dex => {
                        var no_contacts = 0
                        var followers = 0
                                                            ...
                                                            userTransactions.findOneAndUpdate({userid: ObjectId(doc.userid._id)},
                                                                {
                                                                    $push: {
                                                                        transactions: {
                                                                            ...
                                                                            message: "You have donated" + final_mode + " points to primary offer",
                                                                            transaction_id: transaction_id
                                                                        }
                                                                    }
                                                                }, {upsert: true})
                        ...
                        users.save()
                            .then(data => {
                                ...
                                if (data === null) {
                                    ...
                                    userDetails.findOneAndUpdate({userid: ObjectId(req.body.userid)},
                                        {$push: {user_address: ObjectId(data._id)}})
                                        .exec()
                                        .then(dex => {
                                            if (dex === null) {
                                                return res.status(200).json({
